 ...
 * \Swoole\Coroutine\Socket\Exception, \Swoole\ExitException) extends this class. The only one that doesn't is
 * \Swoole\Coroutine\CanceledException, which extends the built-in \Exception class directly — so catching this
 * class catches every exception thrown by Swoole except that one.
 *
