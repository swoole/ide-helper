 ...
 * host, or an "https://" target while Swoole was compiled without OpenSSL support. The helper functions in namespace
 * Swoole\Coroutine\Http (e.g. \Swoole\Coroutine\Http\request()) throw it as well when given an illegal URL or an
 * unsupported scheme.
 *
