...
/**
 * Thrown by \Swoole\Coroutine\Http2\Client in three cases: constructing the client with an empty host (error code
 * SWOOLE_ERROR_INVALID_PARAMS), constructing it with SSL requested while Swoole was compiled without OpenSSL
 * support, and failing to send out buffered control frames while another coroutine is writing to the same
 * connection (error code SWOOLE_ERROR_HTTP2_SEND_CONTROL_FRAME_FAILED).
 *
