...
class Server
{
     ...
     * @see https://github.com/swoole/swoole-src/blob/v6.2.1/ext-src/swoole_server.cc#L50
     * @see https://github.com/swoole/swoole-src/blob/v6.2.1/ext-src/swoole_server_port.cc#L33
     */
     ...
     * @see \Swoole\Constant::OPTION_HEARTBEAT_CHECK_INTERVAL
     * @see https://github.com/swoole/swoole-src/blob/v6.2.1/ext-src/swoole_server.cc#L3054 The actual default value of parameter $ifCloseConnection
     */
