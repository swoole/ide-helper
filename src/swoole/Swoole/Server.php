...
class Server
{
     ...
     * @see https://github.com/swoole/swoole-src/blob/v6.1.6/ext-src/swoole_server.cc#L50
     * @see https://github.com/swoole/swoole-src/blob/v6.1.6/ext-src/swoole_server_port.cc#L33
     */
     ...
     * @see \Swoole\Constant::OPTION_HEARTBEAT_CHECK_INTERVAL
     * @see https://github.com/swoole/swoole-src/blob/v6.1.6/ext-src/swoole_server.cc#L3032 The actual default value of parameter $ifCloseConnection
     */
