...
final class Thread
{
     ...
     *
     * Note that leaving parameter $policy out makes Swoole ask the operating system for an invalid scheduling
     * policy, so the call always fails; pass both parameters explicitly.
     *
